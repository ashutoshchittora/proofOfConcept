...
class Brand {
	...
	private Brand(Builder builder) {
		...
		this.subBrandName = builder.subBrandName;
		this.brandFacet = builder.brandFacet;
		this.brandDescriptionPDP = builder.brandDescriptionPDP;
	}
	...
	/**
	 * Creates builder to build {@link Brand}.
	...
	public static final class Builder {
		...
		public Builder withSubBrandID(int subBrandID) {
			this.subBrandID = subBrandID;
			return this;
		}

		public Builder withSubBrandName(String subBrandName) {
			this.subBrandName = subBrandName;
			return this;
		}

		public Builder withBrandFacet(String brandFacet) {
			this.brandFacet = brandFacet;
			return this;
		}

		public Builder withBrandDescriptionPDP(String brandDescriptionPDP) {
			this.brandDescriptionPDP = brandDescriptionPDP;
			return this;
		}
